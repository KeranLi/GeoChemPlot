...
class Main_GUI(Frame):
    ...
    def createWidget(self):
        # First row
        self.btn11 = Button(self, text='Choose your file path', width=15, command=self.select_file)
        self.btn11.grid(row=0, column=0)
        self.logo_label = Label(self, text='Major and Trace Elements Analysis', font=('黑体', 30, 'bold'))
